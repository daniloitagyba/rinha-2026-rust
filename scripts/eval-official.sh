...
EARLY_CANDIDATES="${EARLY_CANDIDATES:-9800}" \
MIN_CANDIDATES="${MIN_CANDIDATES:-9800}" \
MAX_CANDIDATES="${MAX_CANDIDATES:-11000}" \
...
PROFILE_FRAUD_MIN_COUNT="${PROFILE_FRAUD_MIN_COUNT:-15}" \
